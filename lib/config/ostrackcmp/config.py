...
cfg.MODEL.BACKBONE.DTE_LOC = []
cfg.MODEL.BACKBONE.DTE_KEEP_RATIO = []
cfg.MODEL.BACKBONE.STE_LOC = []
cfg.MODEL.BACKBONE.STE_KEEP_RATIO = []
cfg.MODEL.BACKBONE.TOKEN_TYPE_AWARE_PRUNING = 'FULL_FOREGROUND'
