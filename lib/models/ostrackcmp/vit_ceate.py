...
class CEATEBlock(nn.Module):
    ...
    def forward(self, xz, global_index_sz, global_index_dz, global_index_x, ce_template_mask=None,
                keep_ratio_x=None, keep_ratio_sz=None, keep_ratio_dz=None, num_template=1):
...
class VisionTransformerCEATE(VisionTransformer):
    ...
    def forward_features(self, template_list, search_list, template_anno_list,
        ...
        for i, blk in enumerate(self.blocks):
            (xz, global_index_sz, global_index_dz, removed_index_sz, removed_index_dz,
             global_index_x, removed_index_x, attn, ce_template_mask) = blk(
                xz,
...
def _create_vision_transformer(pretrained=False, **kwargs):
    model = VisionTransformerCEATE(**kwargs)
...
def vit_base_patch16_224_ceate(pretrained=False, **kwargs):
