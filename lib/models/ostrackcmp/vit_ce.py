...
class CEBlock(nn.Module):
    ...
    def forward(self, xz, global_index_z, global_index_x, ce_template_mask=None, keep_ratio_x=None, num_template=1):
    ...
    def forward_features(self, template_list, search_list, template_anno_list,
        ...
        for i, blk in enumerate(self.blocks):
            xz, global_index_z, global_index_x, removed_index_x, attn = \
                blk(xz, global_index_z, global_index_x, ce_template_mask, ce_keep_rate, len(template_list))
